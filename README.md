...
Реализация серверного приложения на FastAPI с аутентификацией, авторизацией (RBAC), работой с базой данных SQLite и защитой документации. Включает все задания контрольной работы №3 (кроме 8.2).
